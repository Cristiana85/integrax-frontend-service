...
@Component({
  selector: 'app-dashboard-file-manager-create-project-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule],
  templateUrl: './dashboard-file-manager-create-project-dialog.component.html',
  styleUrl: './dashboard-file-manager-create-project-dialog.component.scss'
})
export class DashboardFileManagerCreateProjectDialogComponent {
