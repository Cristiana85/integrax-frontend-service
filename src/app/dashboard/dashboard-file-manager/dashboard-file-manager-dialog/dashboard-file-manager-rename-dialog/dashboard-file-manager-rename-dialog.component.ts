...
@Component({
  selector: 'app-dashboard-file-manager-rename-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule],
  templateUrl: './dashboard-file-manager-rename-dialog.component.html',
  styleUrl: './dashboard-file-manager-rename-dialog.component.scss'
})
export class DashboardFileManagerRenameDialogComponent {
