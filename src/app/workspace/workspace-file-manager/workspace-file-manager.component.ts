...
import { WorkspaceFileManagerRenameDialogComponent } from './workspace-file-manager-dialog/workspace-file-manager-rename-dialog/workspace-file-manager-rename-dialog.component';
import { ProjectsService } from 'src/app/services/projects.service';
import { AccountService } from 'src/app/services/account.service';
import { WorkspaceFileManagerCreateProjectDialogComponent } from './workspace-file-manager-dialog/workspace-file-manager-create-project-dialog/workspace-file-manager-create-project-dialog.component';
import { HandleUtils } from 'src/app/utils/utils';

@Component({
  selector: 'app-workspace-file-manager',
  templateUrl: './workspace-file-manager.component.html',
  styleUrls: ['./workspace-file-manager.component.scss']
})
export class WorkspaceFileManagerComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRenameProjectRef: MatDialogRef<WorkspaceFileManagerRenameDialogComponent>,
    public dialogCreateProjectRef: MatDialogRef<WorkspaceFileManagerCreateProjectDialogComponent>
  ) { }
  ...
  showRenameDialog(selectedProject: Project) {
    this.dialogRenameProjectRef = this.dialog.open(WorkspaceFileManagerRenameDialogComponent, {
      width: '510px',
  ...
  showCreateProjectDialog() {
    this.dialogCreateProjectRef = this.dialog.open(WorkspaceFileManagerCreateProjectDialogComponent, {
      width: '510px',
